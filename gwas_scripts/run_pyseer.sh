...
pyseer --lmm --phenotypes pyseer_metadata.tsv --phenotype-column EARTH_SPACE_BINARY --kmers unitig_output/unitigs.txt.gz --similarity distances_names --output-patterns kmer_patterns_apit_isolation_source.txt --cpu 10 > apit_earth_v_space_kmers.txt
